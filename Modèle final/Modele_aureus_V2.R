...
propC1<-graph(run1,c("CRa","CSa","CR","CS"),"S.Aureus colonized people without a virus epidemic")
...
propC3<-graph(run3,c("CRa","CSa","CR","CS"),"S.Aureus colonized peoplewith influenza epidemic, vaccination 50%")
...
propC4<-graph(run4,c("CRa","CSa","CR","CS"),"S.Aureus colonized people with influenza epidemic, vaccination 80%")
