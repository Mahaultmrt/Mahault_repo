...
create_params<-function(beta=0.065,fitness=0.96,deltaRa=0,deltaSa=0,gamma=0.05,rhoR=3*10^-6,rhoS=3*10^-6,rhoRa=3.0*10^-6,rhoSa=3*10^-6,theta=0.0014,omega=0.08, alpha=0.33, sigmaR=1,sigmaS=0,ATB=0.1){
...
thetas<-graph3(run3,c("theta","new_theta"),"Parameter theta for S.pneumonia colonization with 50% of vaccination for influenza")
...
ratio_P$ratio_exp_R=diff$diffIR/diff_exp$diffexp
ratio_P$ratioR_RS_exp=(diff$diffratio)/diff_exp$diffexp
...
diff_sim_P<-diff_graph_sim(diff_sim)
